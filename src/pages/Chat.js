...
export default function Chat() {
  ...
  const [currentToUser, setCurrentToUser] = useState("Ankit");
  ...
  const ContactList = [
    {
      name: "Ankit",
      lastmessage: findLastMessage("Ankit"),
    },

    {
      name: "Utkarsh",
      lastmessage: findLastMessage("Utkarsh"),
    },
    {
      name: "Arpii",
      lastmessage: findLastMessage("Arpii"),
    },
    {
      name: "Adii",
      lastmessage: findLastMessage("Adii"),
    },
    {
      name: "Peter",
      lastmessage: findLastMessage("Peter"),
    },
  ];
